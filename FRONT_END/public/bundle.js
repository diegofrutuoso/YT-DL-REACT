...
var YoutubeDownload = React.createClass({
    ...
    handleSubmitVideo: function () {
        ...
        tempLink.href = 'http://127.0.0.1:8080/youtubeDownload/' + filen + '?id=' + this.props.youtubeId + '&itag=' + this.props.itag;
    ...
    handleSubmitAudio: function () {
        ...
        var tempLink = document.createElement('a');
        tempLink.style.display = 'none';
        tempLink.href = 'http://127.0.0.1:8080/youtubeDownload/' + filen + '?id=' + this.props.youtubeId + '&itag=lowest';
